...
export default function PlansPage() {
  ...
  const handlePayment = (e) => {
    ...
    // TODO: Integrate Paystack PaystackPop
  }
  ...
  return (
    <div className="bg-white"> 
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 items-stretch">
        {isLoading ? (
          ...
          plans?.map((plan) => {
            ...
            const currentOriginalPrice = billingPeriod === "annual" ? plan.annualOriginalPrice : plan.monthlyOriginalPrice
      ...
      {/* Start Free Trial Section - Below Plans */}
      ...
      {/* Payment Checkout Sheet - Multi-Step */}
                    ...
                    <div className="border-t pt-3 space-y-2">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-bold">
                          ${(billingPeriod === "annual" ? selectedPlanData.annualPrice : selectedPlanData.monthlyPrice).toLocaleString()}
                        </span>
                      </div>
                      <div className="flex justify-between items-center">
              ...
              {checkoutStep === 2 && (
                <div className="space-y-6">
                  ...
                  <form onSubmit={handlePayment} className="space-y-4">
                    ...
                    >
                      Pay ${(billingPeriod === "annual" ? selectedPlanData.annualPrice : selectedPlanData.monthlyPrice).toLocaleString()}
                    </Button>
