          ...
          <div className="flex  my-2 flex-col md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex flex-col md:flex-row md:items-center gap-1 md:gap-3 ml-0.5">
              <p className="text-base font-bold">Products</p>
                ...
                <Link href={`/admin/${u}/company/${companySlug}/branches/${branch}/modules/products/categories`}><Button  className="bg-army text-white font-medium text-[10px] h-6 w-fit px-3 hover:bg-army/85">  Categories & Collections </Button></Link>
            </div>
            ...
            <nav className="flex gap-3 mb-1 md:mt-0 mr-0.5">
              ...
              <Link href={`/admin/${u}/company/${companySlug}/branches/${branch}/modules/products/create`}><Button className="bg-core text-white text-xs h-7 hover:bg-core/85">  Create</Button></Link>
            </nav>
          </div>
